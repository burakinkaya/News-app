...
public class FragmentC extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        prg = view.findViewById(R.id.progressBarFragmentC);
    ...
    private void initComponents() {
        recyclerView=view.findViewById(R.id.recyclerViewListofC);
        NewsRepository repo = new NewsRepository();
        repo.getDataByCategoryId(((NewsApp)getActivity().getApplication()).srv,dataHandler,3);
